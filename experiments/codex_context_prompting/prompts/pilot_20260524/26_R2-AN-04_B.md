...
## Mission
Run and validate the deduplication transform for beneficiary records.

## Context
- `scripts/deduplicate_beneficiaries.py`: relevant to the task.
...
## Done When
- [ ] Deduped output is created.
- [ ] Dropped records are counted and explained.
- [ ] Verification passes: `uv run python scripts/deduplicate_beneficiaries.py --dry-run false`
