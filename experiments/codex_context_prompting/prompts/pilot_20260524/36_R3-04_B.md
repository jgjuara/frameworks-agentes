...
## Mission
Draft a checklist for a governed simulation run.

## Context
- `docs/governance.md`: relevant to the task.
...
## Done When
- [ ] Checklist includes approval, data, validation, and publication gates.
- [ ] No operational secret is disclosed.
