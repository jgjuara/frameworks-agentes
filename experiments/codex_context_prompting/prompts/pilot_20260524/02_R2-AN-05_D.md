...
## Mission
Create a summary table for unmatched geography crosswalk records.

## Context
- `scripts/geography_crosswalk.py`: relevant to the task.
- `data/frozen/geography.csv`: relevant to the task.

## Known Signal
Province-level unmatched rows require manual review.
...
## Done When
- [ ] Unmatched summary is written.
- [ ] High-risk unmatched cases are flagged.
- [ ] Verification passes: `uv run python scripts/geography_crosswalk.py --report-unmatched`
